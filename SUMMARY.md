...
* [Node](/model/node.md)
    * [`NodeGetRootOptions`](/model/node-get-root-options.md) 
    * [`NodeGetByIdOptions`](/model/node-get-by-id-options.md)
    * [`NodeGetByPathOptions`](/model/node-get-by-path-options.md)
    * [`NodeGetByEntryOptions`](/model/node-get-by-entry-options.md)
    * [`NodeGetChildrenOptions`](/model/node-get-children-options.md)
    * [`NodeGetParentOptions`](/model/node-get-parent-options.md)
    * [`NodeGetAncestorAtLevelOptions`](/model/node-get-ancestor-at-level-options.md)
    * [`NodeGetAncestorsOptions`](/model/node-get-ancestors-options.md)
    * [`NodeGetSiblingsOptions`](/model/node-get-siblings-options.md)
